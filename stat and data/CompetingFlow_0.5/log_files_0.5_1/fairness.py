...
l = len(my_dict[key]['r1'])
print('l',l)
jatin_fairness=[]
for j in range(0,l):
    d = my_dict['cubic']['r1'][j]+my_dict['reno']['r1'][j]+my_dict['vivace']['r1'][j]
    d = d**2
    g = (my_dict['cubic']['r1'][j]**2)+(my_dict['reno']['r1'][j]**2)+(my_dict['vivace']['r1'][j]**2)
...
plt.title('loss={:.1%} and RTT=1ms'.format(0.005))
plt.show()
